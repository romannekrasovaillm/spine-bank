...
=======
> Что внутри библиотеки (65 скиллов в 9 плагинах) и что попробовать в первую
>>>>>>> origin/main
...
Индекс поиска шире библиотеки: вместе с `[plugins] dirs` читаются каталоги
подключённых в проект харнессов (`.claude/skills`, `.qwen/skills`,
`.gigacode/skills`, `.kimi-code/skills` — туда скиллы кладёт
`arch-be connect <харнесс>`). Иначе поиск был бы пуст до `arch-be init`, хотя
скиллы в проекте уже лежат (T-09); пустой индекс отвечает не «ничего не
найдено», а причиной с адресом библиотеки.
