...
на приёмке handoff-пакета. Состав read-only режима: **36 инструментов** —
...
восемь плейбуков spine-workflows как слэш-команды хоста (см. ниже).
...
Помимо инструментов сервер отдаёт capability **`prompts`**: восемь плейбуков
