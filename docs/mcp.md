...
16 ручных (контроль, знания, split-judge, `rules_suggest`) + 22 мостовых из
...
девять плейбуков spine-workflows как слэш-команды хоста (см. ниже).
...
Помимо инструментов сервер отдаёт capability **`prompts`**: девять плейбуков
