...
(см. README и `кейсы/fleet-spine-drift`); канон расходящегося файла —
majority-версия, при равенстве голосов — тай-брейк **в пользу основного
(первого в списке) дерева**, а ничья без участия основного дерева помечается
явно (`tie=true` в JSON, строка «НИЧЬЯ голосов…», отступники не назначаются;
вердикт DRIFT и exit 1 сохраняются); для каждого worktree показывает
