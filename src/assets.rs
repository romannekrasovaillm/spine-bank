...
/// Встроенные шаблоны исполняемых правил (`assets/rule-templates/**`):
/// «путь в домашнем каталоге харнесса → содержимое». Раскладываются
/// `arch-be init` (см. [`write_defaults`]) и читаются библиотекой шаблонов
/// ([`crate::rule_templates`]) напрямую из бинаря — без предварительного
/// `init` шаблон тоже доступен (`rules template list|show|apply`).
const RULE_TEMPLATE_FILES: &[(&str, &str)] = &[
    (
        "assets/rule-templates/append-only-journal/README.md",
        include_str!("../assets/rule-templates/append-only-journal/README.md"),
    ),
    (
        "assets/rule-templates/append-only-journal/java/pom.xml",
        include_str!("../assets/rule-templates/append-only-journal/java/pom.xml"),
    ),
    (
        "assets/rule-templates/append-only-journal/java/src/main/java/Fakes.java",
        include_str!("../assets/rule-templates/append-only-journal/java/src/main/java/Fakes.java"),
    ),
    (
        "assets/rule-templates/append-only-journal/java/src/main/java/Subject.java",
        include_str!(
            "../assets/rule-templates/append-only-journal/java/src/main/java/Subject.java"
        ),
    ),
    (
        "assets/rule-templates/append-only-journal/java/src/test/java/AppendOnlyJournalTest.java",
        include_str!(
            "../assets/rule-templates/append-only-journal/java/src/test/java/AppendOnlyJournalTest.java"
        ),
    ),
    (
        "assets/rule-templates/append-only-journal/java/violating/Subject.java",
        include_str!("../assets/rule-templates/append-only-journal/java/violating/Subject.java"),
    ),
    (
        "assets/rule-templates/append-only-journal/python/fakes.py",
        include_str!("../assets/rule-templates/append-only-journal/python/fakes.py"),
    ),
    (
        "assets/rule-templates/append-only-journal/python/reference_impl.py",
        include_str!("../assets/rule-templates/append-only-journal/python/reference_impl.py"),
    ),
    (
        "assets/rule-templates/append-only-journal/python/test_append_only_journal.py",
        include_str!(
            "../assets/rule-templates/append-only-journal/python/test_append_only_journal.py"
        ),
    ),
    (
        "assets/rule-templates/append-only-journal/python/violating_impl.py",
        include_str!("../assets/rule-templates/append-only-journal/python/violating_impl.py"),
    ),
    (
        "assets/rule-templates/append-only-journal/template.yaml",
        include_str!("../assets/rule-templates/append-only-journal/template.yaml"),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/README.md",
        include_str!("../assets/rule-templates/consent-before-auto-action/README.md"),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/java/pom.xml",
        include_str!("../assets/rule-templates/consent-before-auto-action/java/pom.xml"),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/java/src/main/java/Fakes.java",
        include_str!(
            "../assets/rule-templates/consent-before-auto-action/java/src/main/java/Fakes.java"
        ),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/java/src/main/java/Subject.java",
        include_str!(
            "../assets/rule-templates/consent-before-auto-action/java/src/main/java/Subject.java"
        ),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/java/src/test/java/ConsentBeforeAutoActionTest.java",
        include_str!(
            "../assets/rule-templates/consent-before-auto-action/java/src/test/java/ConsentBeforeAutoActionTest.java"
        ),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/java/violating/Subject.java",
        include_str!(
            "../assets/rule-templates/consent-before-auto-action/java/violating/Subject.java"
        ),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/python/fakes.py",
        include_str!("../assets/rule-templates/consent-before-auto-action/python/fakes.py"),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/python/reference_impl.py",
        include_str!(
            "../assets/rule-templates/consent-before-auto-action/python/reference_impl.py"
        ),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/python/test_consent_before_auto_action.py",
        include_str!(
            "../assets/rule-templates/consent-before-auto-action/python/test_consent_before_auto_action.py"
        ),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/python/violating_impl.py",
        include_str!(
            "../assets/rule-templates/consent-before-auto-action/python/violating_impl.py"
        ),
    ),
    (
        "assets/rule-templates/consent-before-auto-action/template.yaml",
        include_str!("../assets/rule-templates/consent-before-auto-action/template.yaml"),
    ),
    (
        "assets/rule-templates/generic-property-test/README.md",
        include_str!("../assets/rule-templates/generic-property-test/README.md"),
    ),
    (
        "assets/rule-templates/generic-property-test/python/fakes.py",
        include_str!("../assets/rule-templates/generic-property-test/python/fakes.py"),
    ),
    (
        "assets/rule-templates/generic-property-test/python/test_invariant.py",
        include_str!("../assets/rule-templates/generic-property-test/python/test_invariant.py"),
    ),
    (
        "assets/rule-templates/generic-property-test/template.yaml",
        include_str!("../assets/rule-templates/generic-property-test/template.yaml"),
    ),
    (
        "assets/rule-templates/idempotency-key/README.md",
        include_str!("../assets/rule-templates/idempotency-key/README.md"),
    ),
    (
        "assets/rule-templates/idempotency-key/java/pom.xml",
        include_str!("../assets/rule-templates/idempotency-key/java/pom.xml"),
    ),
    (
        "assets/rule-templates/idempotency-key/java/src/main/java/Fakes.java",
        include_str!("../assets/rule-templates/idempotency-key/java/src/main/java/Fakes.java"),
    ),
    (
        "assets/rule-templates/idempotency-key/java/src/main/java/Subject.java",
        include_str!("../assets/rule-templates/idempotency-key/java/src/main/java/Subject.java"),
    ),
    (
        "assets/rule-templates/idempotency-key/java/src/test/java/IdempotencyKeyTest.java",
        include_str!(
            "../assets/rule-templates/idempotency-key/java/src/test/java/IdempotencyKeyTest.java"
        ),
    ),
    (
        "assets/rule-templates/idempotency-key/java/violating/Subject.java",
        include_str!("../assets/rule-templates/idempotency-key/java/violating/Subject.java"),
    ),
    (
        "assets/rule-templates/idempotency-key/python/fakes.py",
        include_str!("../assets/rule-templates/idempotency-key/python/fakes.py"),
    ),
    (
        "assets/rule-templates/idempotency-key/python/reference_impl.py",
        include_str!("../assets/rule-templates/idempotency-key/python/reference_impl.py"),
    ),
    (
        "assets/rule-templates/idempotency-key/python/test_idempotency_key.py",
        include_str!("../assets/rule-templates/idempotency-key/python/test_idempotency_key.py"),
    ),
    (
        "assets/rule-templates/idempotency-key/python/violating_impl.py",
        include_str!("../assets/rule-templates/idempotency-key/python/violating_impl.py"),
    ),
    (
        "assets/rule-templates/idempotency-key/template.yaml",
        include_str!("../assets/rule-templates/idempotency-key/template.yaml"),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/README.md",
        include_str!("../assets/rule-templates/no-pii-in-logs/README.md"),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/java/pom.xml",
        include_str!("../assets/rule-templates/no-pii-in-logs/java/pom.xml"),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/java/src/main/java/Fakes.java",
        include_str!("../assets/rule-templates/no-pii-in-logs/java/src/main/java/Fakes.java"),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/java/src/main/java/Subject.java",
        include_str!("../assets/rule-templates/no-pii-in-logs/java/src/main/java/Subject.java"),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/java/src/test/java/NoPiiInLogsTest.java",
        include_str!(
            "../assets/rule-templates/no-pii-in-logs/java/src/test/java/NoPiiInLogsTest.java"
        ),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/java/violating/Subject.java",
        include_str!("../assets/rule-templates/no-pii-in-logs/java/violating/Subject.java"),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/python/fakes.py",
        include_str!("../assets/rule-templates/no-pii-in-logs/python/fakes.py"),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/python/reference_impl.py",
        include_str!("../assets/rule-templates/no-pii-in-logs/python/reference_impl.py"),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/python/test_no_pii_in_logs.py",
        include_str!("../assets/rule-templates/no-pii-in-logs/python/test_no_pii_in_logs.py"),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/python/violating_impl.py",
        include_str!("../assets/rule-templates/no-pii-in-logs/python/violating_impl.py"),
    ),
    (
        "assets/rule-templates/no-pii-in-logs/template.yaml",
    ...
    (
        "assets/rule-templates/saga-reserve-compensation/java/pom.xml",
        include_str!("../assets/rule-templates/saga-reserve-compensation/java/pom.xml"),
    ),
    (
        "assets/rule-templates/saga-reserve-compensation/java/src/main/java/Fakes.java",
        include_str!(
            "../assets/rule-templates/saga-reserve-compensation/java/src/main/java/Fakes.java"
        ),
    ),
    (
        "assets/rule-templates/saga-reserve-compensation/java/src/main/java/Subject.java",
        include_str!(
            "../assets/rule-templates/saga-reserve-compensation/java/src/main/java/Subject.java"
        ),
    ),
    (
        "assets/rule-templates/saga-reserve-compensation/java/src/test/java/SagaReserveCompensationTest.java",
        include_str!(
            "../assets/rule-templates/saga-reserve-compensation/java/src/test/java/SagaReserveCompensationTest.java"
        ),
    ),
    (
        "assets/rule-templates/saga-reserve-compensation/java/violating/Subject.java",
        include_str!(
            "../assets/rule-templates/saga-reserve-compensation/java/violating/Subject.java"
        ),
    ),
    (
        "assets/rule-templates/saga-reserve-compensation/python/fakes.py",
        include_str!("../assets/rule-templates/saga-reserve-compensation/python/fakes.py"),
    ),
    (
        "assets/rule-templates/saga-reserve-compensation/python/reference_impl.py",
        include_str!("../assets/rule-templates/saga-reserve-compensation/python/reference_impl.py"),
    ),
    (
        "assets/rule-templates/saga-reserve-compensation/python/test_saga_reserve_compensation.py",
        include_str!(
            "../assets/rule-templates/saga-reserve-compensation/python/test_saga_reserve_compensation.py"
        ),
    ),
    (
        "assets/rule-templates/saga-reserve-compensation/python/violating_impl.py",
        include_str!("../assets/rule-templates/saga-reserve-compensation/python/violating_impl.py"),
    ),
    (
        "assets/rule-templates/saga-reserve-compensation/template.yaml",
        include_str!("../assets/rule-templates/saga-reserve-compensation/template.yaml"),
    ),
    (
        "assets/rule-templates/single-source-of-truth/README.md",
        include_str!("../assets/rule-templates/single-source-of-truth/README.md"),
    ),
    (
        "assets/rule-templates/single-source-of-truth/java/pom.xml",
        include_str!("../assets/rule-templates/single-source-of-truth/java/pom.xml"),
    ),
    (
        "assets/rule-templates/single-source-of-truth/java/src/main/java/Fakes.java",
        include_str!(
            "../assets/rule-templates/single-source-of-truth/java/src/main/java/Fakes.java"
        ),
    ),
    (
        "assets/rule-templates/single-source-of-truth/java/src/main/java/Subject.java",
        include_str!(
            "../assets/rule-templates/single-source-of-truth/java/src/main/java/Subject.java"
        ),
    ),
    (
        "assets/rule-templates/single-source-of-truth/java/src/test/java/SingleSourceOfTruthTest.java",
        include_str!(
            "../assets/rule-templates/single-source-of-truth/java/src/test/java/SingleSourceOfTruthTest.java"
        ),
    ),
    (
        "assets/rule-templates/single-source-of-truth/java/violating/Subject.java",
        include_str!("../assets/rule-templates/single-source-of-truth/java/violating/Subject.java"),
    ),
    (
        "assets/rule-templates/single-source-of-truth/python/fakes.py",
        include_str!("../assets/rule-templates/single-source-of-truth/python/fakes.py"),
    ),
    (
        "assets/rule-templates/single-source-of-truth/python/reference_impl.py",
        include_str!("../assets/rule-templates/single-source-of-truth/python/reference_impl.py"),
    ),
    (
        "assets/rule-templates/single-source-of-truth/python/test_single_source_of_truth.py",
        include_str!(
            "../assets/rule-templates/single-source-of-truth/python/test_single_source_of_truth.py"
        ),
    ),
    (
        "assets/rule-templates/single-source-of-truth/python/violating_impl.py",
        include_str!("../assets/rule-templates/single-source-of-truth/python/violating_impl.py"),
    ),
    (
        "assets/rule-templates/single-source-of-truth/template.yaml",
        include_str!("../assets/rule-templates/single-source-of-truth/template.yaml"),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/README.md",
        include_str!("../assets/rule-templates/unknown-outcome-no-resend/README.md"),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/java/pom.xml",
        include_str!("../assets/rule-templates/unknown-outcome-no-resend/java/pom.xml"),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/java/src/main/java/Fakes.java",
        include_str!(
            "../assets/rule-templates/unknown-outcome-no-resend/java/src/main/java/Fakes.java"
        ),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/java/src/main/java/Subject.java",
        include_str!(
            "../assets/rule-templates/unknown-outcome-no-resend/java/src/main/java/Subject.java"
        ),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/java/src/test/java/UnknownOutcomeNoResendTest.java",
        include_str!(
            "../assets/rule-templates/unknown-outcome-no-resend/java/src/test/java/UnknownOutcomeNoResendTest.java"
        ),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/java/violating/Subject.java",
        include_str!(
            "../assets/rule-templates/unknown-outcome-no-resend/java/violating/Subject.java"
        ),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/python/fakes.py",
        include_str!("../assets/rule-templates/unknown-outcome-no-resend/python/fakes.py"),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/python/reference_impl.py",
        include_str!("../assets/rule-templates/unknown-outcome-no-resend/python/reference_impl.py"),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/python/test_unknown_outcome_no_resend.py",
        include_str!(
            "../assets/rule-templates/unknown-outcome-no-resend/python/test_unknown_outcome_no_resend.py"
        ),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/python/violating_impl.py",
        include_str!("../assets/rule-templates/unknown-outcome-no-resend/python/violating_impl.py"),
    ),
    (
        "assets/rule-templates/unknown-outcome-no-resend/template.yaml",
        include_str!("../assets/rule-templates/unknown-outcome-no-resend/template.yaml"),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/README.md",
        include_str!("../assets/rule-templates/validate-before-side-effect/README.md"),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/java/pom.xml",
        include_str!("../assets/rule-templates/validate-before-side-effect/java/pom.xml"),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/java/src/main/java/Fakes.java",
        include_str!(
            "../assets/rule-templates/validate-before-side-effect/java/src/main/java/Fakes.java"
        ),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/java/src/main/java/Subject.java",
        include_str!(
            "../assets/rule-templates/validate-before-side-effect/java/src/main/java/Subject.java"
        ),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/java/src/test/java/ValidateBeforeSideEffectTest.java",
        include_str!(
            "../assets/rule-templates/validate-before-side-effect/java/src/test/java/ValidateBeforeSideEffectTest.java"
        ),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/java/violating/Subject.java",
        include_str!(
            "../assets/rule-templates/validate-before-side-effect/java/violating/Subject.java"
        ),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/python/fakes.py",
        include_str!("../assets/rule-templates/validate-before-side-effect/python/fakes.py"),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/python/reference_impl.py",
        include_str!(
            "../assets/rule-templates/validate-before-side-effect/python/reference_impl.py"
        ),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/python/test_validate_before_side_effect.py",
        include_str!(
            "../assets/rule-templates/validate-before-side-effect/python/test_validate_before_side_effect.py"
        ),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/python/violating_impl.py",
        include_str!(
            "../assets/rule-templates/validate-before-side-effect/python/violating_impl.py"
        ),
    ),
    (
        "assets/rule-templates/validate-before-side-effect/template.yaml",
        include_str!("../assets/rule-templates/validate-before-side-effect/template.yaml"),
    ),
];

/// Программный доступ к встроенным шаблонам исполняемых правил
/// (`assets/rule-templates/**`).
#[must_use]
pub fn embedded_rule_templates() -> &'static [(&'static str, &'static str)] {
    RULE_TEMPLATE_FILES
}
...
mod tests {
    ...
    ///
    /// Только с фичей `harness`: эталоны разбираются типами `bench` (в слим-сборке
    /// «орган чужого CLI-агента» модуля нет) — проверка разметки принадлежит
    /// полной редакции, а сам факт поставки файлов проверяется и в core.
    #[cfg(feature = "harness")]
    #[test]
